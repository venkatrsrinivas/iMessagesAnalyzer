...
def runTrainTestSave(dataset, info):
	...
	with open("/Users/vsrinivas321/Documents/iMessagesAnalyzer/allModelData.json", "w") as currentFile:
	   currentFile.write(currentJSON)
	#Save/Serialize Weights To HDF5 File.
	model.save_weights("/Users/vsrinivas321/Documents/iMessagesAnalyzer/allWeightData.h5")
